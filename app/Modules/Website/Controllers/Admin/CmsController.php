...
class CmsController extends Controller
{
    ...
    public function eventsCreate(): View { return view('modules.website.cms.events.create'); }
    ...
    public function eventsEdit(Event $event): View { return view('modules.website.cms.events.edit', compact('event')); }
    ...
    public function facilitiesStore(Request $request): RedirectResponse
    {
        ...
        if ($request->hasFile('image')) $validated['image_path'] = $request->file('image')->store('facilities', 'public');
    ...
    public function achievementsCreate(): View { return view('modules.website.cms.achievements.create'); }
    ...
    public function achievementsEdit(Achievement $achievement): View { return view('modules.website.cms.achievements.edit', compact('achievement')); }
