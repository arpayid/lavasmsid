...
use App\Modules\Academic\Services\AcademicEventService;
...
{
    public function __construct(protected AcademicEventService $service) {}
    ...
    {
        $this->service->update($academicEvent, $request->validated());
