<x-public-layout title="Beranda">
    ...
    <div class="relative bg-slate-900 overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-blue-900 via-slate-900 to-blue-950 z-10"></div>
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 text-center lg:text-left flex flex-col lg:flex-row items-center">
            <div class="lg:w-2/3">
                ...
                <p class="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed font-light">
                    {{ $settings->tagline ?? 'Sistem Manajemen Sekolah Modern Terpadu' }}
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    @if(Route::has('public.ppdb'))
                    <a href="{{ route('public.ppdb') }}" class="inline-flex justify-center items-center px-8 py-3.5 border border-transparent text-base font-bold rounded-full text-blue-700 bg-white hover:bg-blue-50 shadow-lg hover:shadow-xl transition-all">
                        Informasi PPDB
                    </a>
                    @endif
            ...
            <div class="lg:w-1/3 mt-12 lg:mt-0 hidden lg:block">
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-2xl">
                    <p class="text-blue-100 italic text-sm mb-4 leading-relaxed line-clamp-4">"{{ $settings->principal_message }}"</p>
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold">{{ substr($settings->principal_name, 0, 1) }}</div>
                        <div>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-end mb-10">
                <div>
                    <h2 class="text-sm font-bold text-blue-600 uppercase tracking-widest mb-2">Berita Terkini</h2>
                    <h3 class="text-3xl font-bold text-slate-900">Kabar Sekolah</h3>
                </div>
                <a href="{{ route('public.news') }}" class="hidden sm:inline-flex items-center gap-2 text-sm font-semibold text-blue-600 hover:text-indigo-800 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <a href="{{ route('public.news.show', $item->slug) }}" class="inline-flex items-center gap-1 text-sm font-semibold text-blue-600 hover:text-indigo-800 transition-colors">
            ...
            <div class="mt-8 text-center sm:hidden">
                <a href="{{ route('public.news') }}" class="inline-flex items-center justify-center w-full px-6 py-3 border border-slate-200 rounded-xl text-sm font-bold text-blue-600 hover:bg-slate-50 transition-colors">
                    Lihat Semua Berita
                </a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div>
                    <div class="flex justify-between items-end mb-8">
                        ...
                        <a href="{{ route('public.events') }}" class="text-sm font-semibold text-blue-600 hover:text-indigo-800 transition-colors">Lihat Semua</a>
                    </div>
                    <div class="space-y-4">
                        ...
                        <div class="flex bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-all group">
                            <div class="bg-blue-50 group-hover:bg-blue-600 transition-colors w-24 shrink-0 flex flex-col items-center justify-center text-blue-600 group-hover:text-white p-4 border-r border-slate-100 group-hover:border-blue-600">
                            ...
                            <div class="p-5 flex-1 flex flex-col justify-center">
                                <h4 class="font-bold text-lg text-slate-900 mb-2 leading-tight group-hover:text-blue-600 transition-colors">{{ $event->title }}</h4>
                                @if($event->location)
                ...
                <div>
                    <div class="flex justify-between items-end mb-8">
                        ...
                        <a href="{{ route('public.achievements') }}" class="text-sm font-semibold text-blue-600 hover:text-indigo-800 transition-colors">Lihat Semua</a>
                    </div>
                    <div class="space-y-4">
