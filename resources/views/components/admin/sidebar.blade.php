    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 text-sm" x-data="{ openGroup: '' }">
        ...
        <div class="mt-3">
            ...
            <div x-show="openGroup === 'people'" x-collapse>
                ...
                <a href="{{ route('admin.staff.index') }}" class="flex items-center gap-3 rounded-xl px-3 py-2 transition hover:bg-slate-800 {{ $activeRoute('admin.staff.*') }}">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    <span x-show="!sidebarCollapsed" x-collapse>Staff</span>
                </a>
                @endif
                @if(auth()->user()->can('guardian.view'))
                <a href="{{ route('admin.guardians.index') }}" class="flex items-center gap-3 rounded-xl px-3 py-2 transition hover:bg-slate-800 {{ $activeRoute('admin.guardians.*') }}">
                    ...
                    <span x-show="!sidebarCollapsed" x-collapse>Orang Tua/Wali</span>
                </a>
                @endif
        ...
        <a href="{{ Route::has('admin.ppdb.index') ? route('admin.ppdb.index') : '#' }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-slate-500 transition hover:bg-slate-800">
