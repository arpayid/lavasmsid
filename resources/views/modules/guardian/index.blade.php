<x-admin-layout heading="Data Orang Tua/Wali">
    <div class="mb-6 flex items-center justify-between">
        ...
        @can('guardian.create')<a href="{{ route('admin.guardians.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>Tambah Orang Tua/Wali</a>@endcan
    </div>
